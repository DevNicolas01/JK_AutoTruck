    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 rounded-2xl bg-green-500 px-10 py-4 text-base font-black text-white shadow-lg shadow-green-950/50 transition-all hover:-translate-y-1 hover:bg-green-600"
        >
          <svg
